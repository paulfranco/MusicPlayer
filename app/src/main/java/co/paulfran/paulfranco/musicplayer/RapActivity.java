...
public class RapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Still D.R.E.", "Dr. Dre", R.drawable.image, R.raw.serenata));
        songs.add(new Song("Nuthin But A G Thang", "Dr. Dre", R.drawable.image, R.raw.serenata));
        songs.add(new Song("Dr. Dre - Kush", "Dr. Dre", R.drawable.image, R.raw.serenata));
