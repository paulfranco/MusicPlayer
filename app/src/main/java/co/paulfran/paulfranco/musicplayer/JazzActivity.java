...
public class JazzActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("My My My", "Gerald Albright", R.drawable.image, R.raw.serenata));
        songs.add(new Song("Bermuda Nights", "Gerald Albright", R.drawable.image, R.raw.serenata));
        songs.add(new Song("So Amazing", "Gerald Albright", R.drawable.image, R.raw.serenata));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create and setup the Media Player for the audio associated with the word
                    mMediaPlayer = MediaPlayer.create(JazzActivity.this, song.getAudioResourceId());
