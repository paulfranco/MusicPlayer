...
public class ClassicalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Serenade K 525 Eine Kleine Nachtmusik Allegro", "Mozart", R.drawable.image, R.raw.serenata));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    // Create and setup the Media Player for the audio associated with the word
                    mMediaPlayer = MediaPlayer.create(ClassicalActivity.this, song.getAudioResourceId());
